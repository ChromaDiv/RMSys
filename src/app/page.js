  ...
  return (
    <div className="min-h-screen text-foreground selection:bg-indigo-500/30">
      ...
      <motion.nav
        ...
        className="fixed z-[1000] left-0 right-0 mx-auto border border-transparent backdrop-blur-xl transition-[background-color,border-color,box-shadow] duration-300 overflow-hidden bg-white/60 dark:bg-white/10 shadow-[0_0_30px_0px_rgba(79,70,229,0.35)] dark:shadow-[0_0_50px_0px_rgba(79,70,229,0.5)] border-white/20 dark:border-white/10"
      >
